...
joblib.dump(encoder, 'model/encoder_1.pkl')
...
joblib.dump(scaler, 'model/scaler_1.pkl')
...
scaler_data.to_excel('model/scaler_1.xlsx', index=False)
...
joblib.dump(best_xgb, 'model/best_xgb_model_12.pkl')
