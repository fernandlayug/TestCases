...
data = pd.read_excel('datasets/dummy_selected_data_1.xlsx')
...
joblib.dump(scaler, 'datasets/scaler_4.pkl')
...
scaler_data.to_excel('datasets/scaler_4.xlsx', index=False)
...
joblib.dump(best_xgb, 'datasets/best_xgb_model_16.pkl')
