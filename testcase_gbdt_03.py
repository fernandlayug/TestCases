...
import openpyxl
import numpy as np
import pandas as pd  # Re-added for pd.read_excel
import shap

# Load your dataset from Excel (replace 'selected_data_1.xlsx' with your Excel file)
data = pd.read_excel('datasets/normalized_selected_data_2.xlsx')
...
joblib.dump(encoder, 'datasets/encoder_3.pkl')
...
joblib.dump(scaler, 'datasets/scaler_3.pkl')
...
scaler_data.to_excel('datasets/scaler_3.xlsx', index=False)
...
joblib.dump(best_xgb, 'datasets/best_xgb_model_15.pkl')
