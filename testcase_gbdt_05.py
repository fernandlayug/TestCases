...
data = pd.read_excel('datasets/normalized_selected_data_1.xlsx')
...
joblib.dump(scaler, 'model/scaler_5.pkl')
joblib.dump(encoder, 'model/encoder_5.pkl')
...
scaler_data.to_excel('model/scaler_5.xlsx', index=False)
...
encoder_df.to_excel('model/encoder_5.xlsx', index=False)
...
joblib.dump(best_xgb, 'model/best_xgb_model_15.pkl')
